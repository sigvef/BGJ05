...
TileRenderer.prototype.blit = function(sprite, srcX, srcY){
    ...
    this.context.fillText(this.render_col+","+this.render_row ,this.render_col*blockSize*GU+0.6*GU, this.render_row*blockSize*GU+0.6*GU, blockSize*GU, blockSize*GU);
